...
<head>
    ...
    <link rel="mask-icon" href="favicons/safari-pinned-tab.svg" color="#ae5bd5">
    <link rel="shortcut icon" href="favicons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="AvengerWeb">
    <meta name="application-name" content="AvengerWeb">
